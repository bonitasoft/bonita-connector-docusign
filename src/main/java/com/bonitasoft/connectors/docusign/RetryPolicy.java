...
/**
 * Retry policy with exponential backoff and jitter for DocuSign API calls.
...
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws DocuSignException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new DocuSignException("Unexpected error during API call", e);
            }
        }
    }
